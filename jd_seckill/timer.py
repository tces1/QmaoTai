...
class Timer(object):
    ...
    def jd_time(self):
        ...
        :return:
        """
        url = 'https://api.m.jd.com/api?appid=paimai&functionId=getPaimaiRealTimeData&body={%22paimaiId%22:276304054}'
        ret = requests.get(url).text
        js = json.loads(ret)
        return int(js["data"]["confirmationUrl"].split("?time=")[1])
